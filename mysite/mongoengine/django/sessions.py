...
from polls.mongoengine.document import Document
from polls.mongoengine import fields
from polls.mongoengine.queryset import OperationError
from polls.mongoengine.connection import DEFAULT_CONNECTION_NAME
    ...
    def load(self):
        try:
            ...
            if MONGOENGINE_SESSION_DATA_ENCODE:
                return self.decode(force_text(s.session_data)) # force_unicode
            else:
